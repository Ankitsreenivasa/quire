...
export function Dropzone({ accept, multiple, onFiles, compact }: Props): JSX.Element {
  ...
  return (
    <div
      ...
      className={cn(
        'flex cursor-pointer flex-col items-center justify-center rounded-xl border-2 border-dashed border-border bg-surface text-center transition-colors hover:border-brand/60 hover:bg-surface-2',
